    ...
    <>
      ...
      <div className="flex min-h-[60vh] items-center justify-center bg-background px-4 py-20">
        <div className="max-w-md text-center">
          ...
          <h1 className="mt-2 font-display text-5xl font-bold text-[color:var(--forest)]">
          ...
          <div className="mt-6">
            <Link
              to="/"
              className="inline-flex items-center justify-center rounded-full bg-[color:var(--forest)] px-5 py-2.5 text-sm font-semibold text-[color:var(--paper)] hover:bg-[color:var(--moss)]"
            >
              Voltar ao início
            </Link>
          </div>
      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="rounded-full bg-[color:var(--forest)] px-4 py-2 text-sm font-medium text-[color:var(--paper)]"
          >
            Tentar novamente
          </button>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Instituto Raízes do Futuro — Ponto de Cultura e Educação Ambiental" },
      {
        name: "description",
        content:
          "Ponto de Cultura dedicado à educação ambiental, à leitura, à cultura e à participação comunitária.",
      },
      { name: "author", content: "Instituto Raízes do Futuro" },
      { property: "og:site_name", content: "Instituto Raízes do Futuro" },
      {
        property: "og:title",
        content: "Instituto Raízes do Futuro — Ponto de Cultura e Educação Ambiental",
      },
      {
        property: "og:description",
        content: "Cultura, educação ambiental e valorização dos saberes comunitários.",
      },
    ...
    scripts: [{ src: "https://vlibras.gov.br/app/vlibras-plugin.js", defer: true }],
  }),
      ...
      <body>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `window.addEventListener('load', function(){ try { new window.VLibras.Widget('https://vlibras.gov.br/app'); } catch(e){} });`,
          }}
        />
        <Scripts />
      </body>
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <a
        href="#conteudo"
        className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-50 focus:bg-[color:var(--forest)] focus:text-[color:var(--paper)] focus:px-3 focus:py-2 focus:rounded"
      >
